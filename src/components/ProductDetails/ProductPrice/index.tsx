    ...
    <div className="flex items-center flex-col items-start">
      ...
      <div className="mb-[12px]">
        ...
        <h1 className="text-[#535665] font-[400] text-[20px] pt-[5px] pb-[14px] m-[0px]  opacity-[0.8]">
          Striped Polo Collar Slim Fit T-shirt
        </h1>
        <div className="flex items-center justify-between px-[8px] py-[2px] max-w-[150px] border-1 border-solid border-[#eaeaec] cursor-pointer hover:border-[#535766]">
          <div className="flex items-center justify-between">
            <span className="text-[16px] font-[700]">4.4</span>
            <StarIcon className="border-r-2 border-[#eaeaec] text-[#14958f] scale-[0.7]" />
          </div>
      ...
      {/* product price */}
      <div className=" mt-[14px] mb-[5px] w-[270px] flex justify-between">
        <span className="font-[700] text-[#282c3f] text-[24px]">₹359</span>
        <span className="font-[500] text-[#535665] text-[20px] opacity-[0.6] leading-[1.2] line-through">
          MRP ₹399
        </span>
        <span className="font-[700] text-[#ff905a] text-[20px]">(10% OFF)</span>
      </div>
      ...
      <div className="my-[12px]">
        ...
        <div className="flex gap-[15px] flex-wrap">
          {PRODUCT_DETAIL_CONSTANTS.MORE_COLOR_PRODUCT_IMAGES.map(
            (img, index) => (
              <img src={img} key={index} className="h-[73px] w-[55px]" />
            )
          )}
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-[10px] h-[54px] w-full mb-[23px]">
        <button className="cursor-pointer bg-[#ff3f6c] max-w-[313px] w-full text-[#fff] font-bold text-[14px] font-[700] rounded-[4px] flex items-center justify-center gap-[6px] hover:bg-[#ff527b] hover:border-transparent">
          <ShoppingBagOutlined className="!w-[20px] !h-[20px]" />
          <span>ADD TO BAG</span>
        </button>
        <button className="cursor-pointer border-[#d4d5d9] text-[#282c3f] bg-[#fff] font-bold text-[14px] font-[700] rounded-[4px] flex items-center justify-center gap-[6px] hover:border-[#535766] w-full max-w-[207px]">
          <FavoriteBorderIcon className="!w-[20px] !h-[20px]" />
          <span>WISHLIST</span>
        </button>
      </div>
      ...
      <div className="w-full mt-[30px]">
        <div className="font-[700] text-[16px] text-[#282c3f] m-[0px] flex items-center gap-[10px]">
          DELIVERY OPTIONS
          <img src={DeliveryIcon} className="h-[24px] w-[24px]" />
        </div>
